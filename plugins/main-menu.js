...
┃☠︎︎ ➬ *Cliente:* %name
┃☠︎︎ ➬ *Estrellas:* %limit
┃☠︎︎ ➬ *Nivel:* %level [ %xp4levelup Xp Para Subir De Nivel]
┃☠︎︎ ➬ *Xp:* %exp / %maxexp
┃☠︎︎ ➬ *TotalXp:* %totalexp
 ╰━─━─━─≪✞︎≫─━─━─━╯
╔──────¤✞︎¤──────╗
...
┃☠︎︎ ➬ *Prefijo:* [ *%_p* ]
┃☠︎︎ ➬ *Rutina:* %muptime 
┃☠︎︎ ➬ *Database:*  %totalreg
╰━─━─━─≪✞︎≫─━─━─━╯
     
   ⏤͟͟͞͞☠︎︎𝗣𝗥𝗔𝗞𝗛𝗔𝗥𝗣𝗘𝗥ꗄ➺
◆━━━━━━━▣✞︎▣━━━━━━━━◆ 
 %readmore
\t\t\t☠︎︎_*𝐋𝐈𝐒𝐓𝐀 𝐃𝐄 𝐂𝐎𝐌𝐀𝐍𝐃𝐎𝐒*_ ☠︎︎
`.trimStart(),
  header: '╭═════⊹⊱≼「 *%category* 」≽⊰⊹════•',
  body: '┃☠︎︎› ✞︎ . %cmd %islimit %isPremium\n',
  footer: '╰═════⊹⊱☠︎︎⊰⊹═════╯',
  after: `© ${textbot}`,
}
...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
 ...
 readmore: readMore
    ...
    let pp = 'https://i.ibb.co/dMB2TXv/file.jpg'
    let pp2 = 'https://i.ibb.co/DgH6L4k/file.jpg'
    let pp3 = 'https://i.ibb.co/HqXStC1/file.jpg'
    let pp4 = 'https://i.ibb.co/rp5QKbx/file.jpg'
    let pp5 = 'https://i.ibb.co/J7rwC2Y/file.jpg'
    let pp6 = 'https://i.ibb.co/dMB2TXv/file.jpg'
    let pp7 = 'https://i.ibb.co/Nny2v01/file.jpg'
    let pp8 = 'https://i.ibb.co/G32PQmC/file.jpg'
    let pp9 = 'https://i.ibb.co/ggd49th/file.jpg'
    let pp10 = 'https://i.ibb.co/JnN5NCM/file.jpg'
    let pp11 = 'https://i.ibb.co/wpXHmyc/file.jpg'
    let pp12 = 'https://i.ibb.co/zP3H8Mg/file.jpg'
    let pp13 = 'https://i.ibb.co/DgH6L4k/file.jpg'
    let pp14 = 'https://i.ibb.co/dMB2TXv/file.jpg'
    let pp15 = 'https://i.ibb.co/Nny2v01/file.jpg'
    let img = 'https://i.ibb.co/XCx285S/file.jpg'
    await m.react('🚀')
